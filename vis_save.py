...
def show_polygons(image, polys, title, color_id=None, save_path=None):
    plt.axis('off')
    plt.imshow(image)
...
def visualize(ANN_FILE: str, PRED_FILE: str, IMAGE_DIR: str,
    ...
    for img_id in img_ids:
        ...
        if INSTANCE:
            ...
            show_polygons(ins_img, ins, title='GT', color_id=0,
                          save_path=f'./results/gt_instance_{img_id}_{INS_ID}.png')
            show_polygons(ins_img, dt_ins, title='Pred', color_id=1,
                          save_path=f'./results/pred_instance_{img_id}_{INS_ID}.png')
            ...
            show_polygons(img, dt_polygons, title=f'Pred: img {img_id}',
                          save_path=f'./results/pred_image_{img_id}.png')
            show_polygons(img, gt_polygons, title=f'GT: img {img_id}',
                          save_path=f'./results/gt_image_{img_id}.png')
